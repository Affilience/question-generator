    ...
    return (
      <div className="text-center p-8">
        <div className="text-gray-500 mb-4">
          ...
          <p className="text-sm">We haven&apos;t written notes for this topic yet.</p>
        </div>
        {/* The old "Generate Theory Notes" button pointed at /generate-theory,
            a route that does not exist, so the only action on this dead-end
            page was a 404. Send people to practice instead, which does work. */}
        <a
          href="/start"
          className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
        >
          Practise this topic instead
        </a>
      </div>
    );
  }
