...
const plans: Plan[] = [
  {
    ...
    features: [
      ...
      { text: 'Print individual questions', included: true },
      { text: 'Difficulty control', included: false },
      { text: 'Print question worksheets', included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { text: '3 custom papers per week', included: true, highlight: true },
      { text: 'Print question worksheets', included: true, highlight: true },
      { text: 'Full difficulty control', included: true },
      { text: 'Bookmark questions', included: true },
      { text: 'Print custom papers (PDF)', included: false },
