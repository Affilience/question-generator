...
export class UltraImprovedQuestionSelector {
  ...
  private getQuestionTypeMarks(type: QuestionType): number[] {
    ...
    const marks: Record<QuestionType, number[]> = {
      ...
      // History/English Lit-specific
      'chronology-analysis': [4, 6, 8, 10],
      'historical-significance': [8, 10, 12, 15, 20],
      'poetry-comparison': [8, 10, 12, 15, 20],
      'character-analysis': [6, 8, 10, 12, 15],
    };
