...
/**
 * Edexcel GCSE Mathematics 1MA1 Specification Topics
 *
 * Aligned to the official Edexcel/Pearson specification content areas:
 * - Number
 * - Algebra
...
export function getEdexcelTopicById(id: string): Topic | undefined {
  return edexcelTopics.find((topic) => topic.id === id);
}
