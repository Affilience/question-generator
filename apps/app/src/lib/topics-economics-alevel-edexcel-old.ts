...
export const edexcelALevelEconomicsTopics: Topic[] = [
  ...
  // Additional specific policy topics that were missing
  {
    id: 'fiscal-policy',
    examBoard: 'edexcel',
    name: 'Fiscal Policy',
...

  {
    ...
    description: 'Bank of England interest rates and money supply control',
    icon: '🏦',
    color: 'bg-blue-500',
    paperRestriction: 'Paper 2, Paper 3',
    subtopics: [
...

  {
    ...
    description: 'Government economic goals and policy conflicts',
    icon: '🎯',
    color: 'bg-rose-600',
    paperRestriction: 'Paper 2, Paper 3',
    subtopics: [
