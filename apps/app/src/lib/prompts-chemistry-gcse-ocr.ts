...
3. Includes proper mark allocation in square brackets [n]
...
**Question:**
[Question text with mark allocation in square brackets, e.g. [3]]

**Mark Scheme:**
[Marking points - one point per mark available, using OCR conventions]

**Explanation:**
[Full worked answer with clear reasoning, showing all calculation steps]

**Diagram (optional):**
[Include a diagram JSON if the question benefits from a visual - apparatus setup, particle diagrams, etc.]
