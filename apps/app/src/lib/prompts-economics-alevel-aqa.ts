...
- "Using the data in Extract A, analyse the causes of [specific economic issue shown in data] and examine the likely consequences for the economy" (10 marks)
...
- Example: "Using the data in Figure 1, analyse the factors that explain the changes in unemployment shown and examine the likely effects on government fiscal policy"
