...
3. Includes proper mark allocation in brackets
...
**Question:**
[Question text with mark allocation in brackets, e.g. (3)]

**Mark Scheme:**
[Marking points - one point per mark available, using Edexcel conventions]
